...
from .charts.bar import save_simple_bar
...
def render_demo() -> None:
    """
    egy minimális demo HTML-riportot renderel a local/output/html alá (base.html.j2 sablonból).
    a brandelt CSS-t a local/assets/css/brand.css helyről olvassa.
    """
    ...
    # demo adatok + grafikon generálás
...
def render_cover_demo() -> None:
    ...
    A szükséges fájlokat a local/assets alól várjuk:
    ...
    if missing:
        # nem állunk le – csak figyelmeztetünk; a sablon fallbackel annyira, amennyire tud
